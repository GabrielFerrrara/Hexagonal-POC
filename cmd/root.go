...
import (
	...
	dbInfra "github.com/gabrielferrrara/hexagonal-POC/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hexagonal-POC.yaml)")
