...
import (
	...
	"github.com/gabrielferrrara/hexagonal-POC/adapters/cli"
	mock_application "github.com/gabrielferrrara/hexagonal-POC/application/mocks"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s with the name %s has been created with the price %f and status status %s",
