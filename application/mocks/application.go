...
// Command mockgen -destination=application/mocks/application.go -source=application/product.go application
...
import (
	...
	application "github.com/gabrielferrrara/hexagonal-POC/application"
